app2.controller('risk_profile04_4d', function ($scope,$http,$state,$translate,$timeout) {
...
//		$scope.main.AddPage="add_contract"
  ...
  $scope.curr_page='risk_profile04_4d'
...
*/
   ...
   $scope.back=function(passo){
     if (passo>0){
         localstorage('risk_final_4d',JSON.stringify({action:'',location:$scope.page.location, prev_page:$scope.curr_page}))
         $state.go('risk_final_4d' )
         return;
     }
     if (passo==-1){
