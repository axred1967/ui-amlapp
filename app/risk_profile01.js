app2.controller('risk_profile01', function ($scope,$http,$state,$translate,$timeout,$stateParams,$interval) {
  //gestisco lo state parameter
    ...
    $scope.back=function(passo){
      if (passo>0){
        $scope.pages['risk_profile0'+ passo ]={action:'',location:$scope.page.location,prev_page:$state.current.name,agg:$scope.page.agg}
