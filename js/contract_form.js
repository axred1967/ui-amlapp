...
function contract_form()
{
    ...
    {
        var firstnamemsg ="Please enter  Name";
        var lastnamemsg = "Please enter Surname";
    ...
    if($('#actofperson').is(":checked"))
    {
        ...
        //var act_username = $.trim($('#act_username').val());
    ...
    else
    {
        ...
        $.ajax ({
            type: "POST",
            url: SERVICEURL,
            data: {"action":"contract_form",id:id,customer_id:customer_id,pr_of_service_contract:pr_of_service_contract,scope_contract:scope_contract,nature_contract:nature_contract,name_person_company:name_person_company,economic_value:economic_value,'act_first_name':act_name,'act_last_name':act_surname,'act_email':act_email,'act_mobile':act_mobile,'act_address':act_address,'actofperson':actofperson,act_resi_country:act_resi_country,act_domi_country:act_domi_country,act_domi_address:act_domi_address,act_nationality :act_nationality,act_ficscal_no:act_ficscal_no,act_dob:act_dob,act_country_birth:act_country_birth,act_docu_identity:act_docu_identity,act_authority_realesed_doc:act_authority_realesed_doc,act_realase_date:act_realase_date,act_validity_date:act_validity_date,act_profession:act_profession,act_telephone:act_telephone,act_fax:act_fax,act_annual_income:act_annual_income,act_password:act_password,image_document:image_document,imagename:imagename     },
            crossDomain: true,
            success:function(responceData){
                    $('#loader_img').hide();
