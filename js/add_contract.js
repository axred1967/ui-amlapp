   ...
   // var actedcompnay = $('#actofcompany').val();
    ...
    else
    {
        ...
        $.ajax ({
            type: "POST",
            url: SERVICEURL2,
            data: {"action":"addcustomer",id:id,email:email,usertype:usertype,customer_name:customer_name,customer_email:customer_email,customer_mobile_number:customer_mobile_number,customer_address_resi:customer_address_resi,actedcompnay:actedcompnay},
            crossDomain: true,
